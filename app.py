...
# --- MONKEYPATCH TO FIX SPACES CRASH ---
# The 'watchfn_spaces' function in Gradio tries to use 'jurigged' for reloading,
# which is currently broken in this environment. We disable it here.
import gradio.utils
def no_op(*args, **kwargs): pass
gradio.utils.watchfn_spaces = no_op
# ---------------------------------------
...
if __name__ == "__main__":
    ...
    demo.launch(
        server_name="0.0.0.0",
        server_port=7860,  # <--- THIS IS THE FIX
        share=False,
        ssr_mode=False
    )
